...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-[1800] flex max-w-[calc(100vw-2rem)] items-center gap-3 rounded-2xl border border-border bg-card p-3 pr-2.5 shadow-lg sm:max-w-xs">
      <LogoMark size={32} />
