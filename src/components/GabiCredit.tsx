...
export default function GabiCredit({ className = "" }: { className?: string }) {
  return (
    <div
      className={`flex w-full items-start justify-center gap-1 text-center text-[10px] text-muted sm:mx-auto sm:w-auto sm:text-xs ${className}`}
    >
      <WhatsAppIcon size={13} className="mt-0 shrink-0 text-[#25D366]" />
